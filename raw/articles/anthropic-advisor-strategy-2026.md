...
ingested: 2026-07-11
sha256: 7aa52bec2c6a93035b753f8fddbe8327d138b35d8e6e595b7e083373abc1f430
---
...
We recommend running your existing eval suite against Sonnet solo, Sonnet executor with Opus advisor, and Opus solo.

### Benchmark methodology (footnotes)
- **SWE-bench Multilingual:** Sonnet 4.6 solo used adaptive thinking. Sonnet 4.6 + Advisor used Anthropic's suggested system prompt for coding with thinking turned off. Both runs used high effort with bash and file editing tools. Scores averaged over five trials of 300 problems across nine languages. Opus 4.6 was the advisor model in all runs.
- **BrowseComp:** All runs used thinking turned off with web search and web fetch tools. Sonnet 4.6 runs used medium effort. Sonnet 4.6 + Advisor used the suggested coding system prompt; Haiku 4.5 + Advisor did not. No programmatic tool calling or context compaction. Scores based on 1,266 problems, one attempt per problem. Opus 4.6 was the advisor model.
- **Terminal-Bench 2.0:** All runs used thinking turned off with bash and file editing tools. Sonnet 4.6 runs used medium effort. Neither advisor run used the suggested coding system prompt. Each task ran in an isolated pod with 3x resource allocation and a 1x timeout. Scores averaged over five attempts per task across 89 tasks. Opus 4.6 was the advisor model.
